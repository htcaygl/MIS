...
public class BrowserUtils {
    ...
    public static WebElement waitForVisibility(WebElement element, int timeToWaitInSec) {
        Duration durationInSeconds = Duration.ofSeconds(timeToWaitInSec);

        WebDriverWait wait = new WebDriverWait(Driver.get(), durationInSeconds);
    ...
    public static WebElement waitForVisibility(By locator, int timeout) {
        ...
        WebDriverWait wait = new WebDriverWait(Driver.get(), durationInMinutes);
    ...
    public static void waitForPageToLoad(long timeOutInSeconds) {
        ...
        try {
            Duration durationInSeconds = Duration.ofSeconds(timeOutInSeconds);
            WebDriverWait wait = new WebDriverWait(Driver.get(), durationInSeconds);
